...
typedef PikafishInfoCallbackNative =
    Void Function(
      Int32 depth,
      Int32 seldepth,
      Int32 multipv,
...
typedef PikafishBestmoveCallbackNative =
    Void Function(Pointer<Char> bestmove, Pointer<Char> ponder);
...
typedef PikafishSetInfoCallbackNative =
    Void Function(Pointer<NativeFunction<PikafishInfoCallbackNative>> cb);
typedef PikafishSetInfoCallbackDart =
    void Function(Pointer<NativeFunction<PikafishInfoCallbackNative>> cb);

typedef PikafishSetBestmoveCallbackNative =
    Void Function(Pointer<NativeFunction<PikafishBestmoveCallbackNative>> cb);
typedef PikafishSetBestmoveCallbackDart =
    void Function(Pointer<NativeFunction<PikafishBestmoveCallbackNative>> cb);

typedef PikafishSetPositionNative =
    Void Function(Pointer<Char> fen, Pointer<Char> moves);
typedef PikafishSetPositionDart =
    void Function(Pointer<Char> fen, Pointer<Char> moves);
...
typedef PikafishSetOptionNative =
    Void Function(Pointer<Char> name, Pointer<Char> value);
typedef PikafishSetOptionDart =
    void Function(Pointer<Char> name, Pointer<Char> value);
